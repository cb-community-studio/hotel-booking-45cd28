...
import seederData from "./reservation.seeder.json";
...
const ReservationSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(ReservationSeederDialogComponent);
