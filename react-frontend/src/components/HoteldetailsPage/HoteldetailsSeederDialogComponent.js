...
import seederData from "./hoteldetails.seeder.json";
...
const HoteldetailsSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(HoteldetailsSeederDialogComponent);
